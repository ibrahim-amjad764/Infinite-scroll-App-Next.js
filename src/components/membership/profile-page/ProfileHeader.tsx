      ...
      <CardContent className="pt-6 px-4 sm:px-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          ...
          <Button
            variant="outline"
            asChild
            className="text-gray-500 h-9 transition-all duration-200 ease-in-out hover:scale-105 active:scale-95">
        ...
        <div className="flex flex-col items-center text-center gap-6 md:flex-row md:items-center md:text-left">
          ...
          {showEditButton && onEdit && (
            <Button
              variant="default"
              onClick={onEdit}
              className="w-full md:w-auto transition-all duration-200 ease-in-out hover:scale-105 active:scale-95"> Edit Profile
            </Button>
          )}
        </div>
      </CardContent>
