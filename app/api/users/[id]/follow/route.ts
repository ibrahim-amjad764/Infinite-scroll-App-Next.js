...
// try {
//   // Only create a notification if the user is following someone else (not themselves)
...
// }
// // // error
// // Argument of type '{ recipientId: string; senderId: string; type: NotificationType.FOLLOW; message: string; }' is not assignable to parameter of type '{ recipientId: string; senderId?: string | undefined; type: NotificationType; message: string; postId: string; }'.
// //   Property 'postId' is missing in type '{ recipientId: string; senderId: string; type: NotificationType.FOLLOW; message: string; }' but required in type '{ recipientId: string; senderId?: string | undefined; type: NotificationType; message: string; postId: string; }'.ts(2345)
// // notification.service.ts(202, 5): 'postId' is declared here.
// // (property) senderId?: string | undefined
//     /**
//      * Final response
//      */
//     return NextResponse.json({
