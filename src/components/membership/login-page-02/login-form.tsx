...
const LoginForm = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    let userCredential: any; // Declare userCredential variable here to access it later
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-tr from-gray-700 via-gray-800 to-gray-600 px-4">
      <motion.div
